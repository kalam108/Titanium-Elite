  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <header className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-300">
            ...
            <a href="#" className="text-blue-400 font-bold border-b-2 border-blue-400 py-5">Community</a>
      ...
      <div className="sticky top-16 z-40 bg-slate-950/90 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 overflow-x-auto custom-scrollbar flex items-center gap-2">
          {FILTERS.map(filter => (
            <button
              key={filter}
