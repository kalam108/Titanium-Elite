...
export default function HealthcareEmergencyPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-red-500/30 pb-20">
      ...
      <header className="sticky top-0 z-40 bg-slate-950/90 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-300">
            ...
            <a href="#" className="text-red-400 font-bold border-b-2 border-red-500 py-5">Healthcare & Emergency</a>
          </nav>
      ...
      {/* Main Content */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
